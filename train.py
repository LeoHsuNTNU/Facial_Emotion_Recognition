...
parser.add_argument("--enable_dropout", type=bool,default=False, dest='enable_dropout', help="Enable dropout layers or not. Default is False.")
...
enable_dropout = tf.constant(args.enable_dropout, dtype=tf.bool)
